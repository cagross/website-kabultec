<?php
/**
 * 31/1/20. Template to render the 'Related Posts' section for the Spacious theme.  This has been copied from parent theme to child theme to ensure the author of each post in the 'Related Posts' section does not display.  To ensure this, I have commented out the <span class="by-author author vcard"> line below.
 *
 * @package WordPress
